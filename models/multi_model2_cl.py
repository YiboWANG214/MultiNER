...
class MMBertQueryNER(BertPreTrainedModel):
    def __init__(self, 
        ...
        # self.bert = TextEncoder(bert_model_path, encoder_config_dict[0], encoder_config_dict[1], encoder_config_dict[2], encoder_config_dict[3], encoder_config_dict[4])
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None):
        ...
        # tower1 = self.tower1(bert_outputs[0]) # [1, batch_size, seq_len, 768] => [1, batch_size, seq_len, 32]
        # tower2 = self.tower2(bert_outputs[1])
        ...
        # tower1 = bert_outputs[0].unsqueeze(0)
        # tower2 = bert_outputs[1].unsqueeze(0)
        # tower3 = bert_outputs[2].unsqueeze(0)
        # tower4 = bert_outputs[3].unsqueeze(0)
        # tower5 = bert_outputs[4].unsqueeze(0)
        # tower6 = bert_outputs[5].unsqueeze(0)
        # tower7 = bert_outputs[6].unsqueeze(0)
        tower1 = bert_outputs[0] # [batch_size, seq_len, 768]
        tower2 = bert_outputs[1]
        tower3 = bert_outputs[2]
        tower4 = bert_outputs[3]
        tower5 = bert_outputs[4]
        tower6 = bert_outputs[5]
        tower7 = bert_outputs[6]
        ...
        output_embeddings.append(tower1)
        ...
        output_embeddings.append(tower2)
        ...
        output_embeddings.append(tower3)
        ...
        output_embeddings.append(tower4)
        ...
        output_embeddings.append(tower5)
        ...
        output_embeddings.append(tower6)
        ...
        output_embeddings.append(tower7)

        new_start_logits = []
        new_end_logits = []
        new_span_logits = []
        new_output_embeddings=torch.stack(output_embeddings)
        ...
        return new_start_logits, new_end_logits, new_span_logits, new_output_embeddings
