...
from multi_task_NER.proposed_model.datasets.mm_ner_dataset import MMNERDataset
...
class BertLabeling(pl.LightningModule):
    ...
    def add_model_specific_args(parent_parser):
        ...
        parser.add_argument("--mm_dropout", type=float, default=0.1,
                            help="mm dropout rate")
    ...
    def get_dataloader(self, prefix="train", limit: int = None) -> DataLoader:
        ...
        vocab_path = os.path.join("/mnt/WDRed4T/yibo/multi_task_NER/proposed_model/BERT/bert-base-uncased", "bert-base-uncased-vocab.txt")
